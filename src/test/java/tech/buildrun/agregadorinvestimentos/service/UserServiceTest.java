...
class UserServiceTest {
   ...
   class createUser{
       ...
       void shouldCreateAUserWithSucess(){
           ...
           // Assert
            ...
            var userCaputred = userArgumentCaptor.getValue();

            assertEquals(input.username(), userCaputred.getUsername());
            assertEquals(input.email(), userCaputred.getEmail());
            assertEquals(input.password(), userCaputred.getPassword());
       }
   ...
   class deleteById {
       ...
       @Test
       @DisplayName("Should delete user with sucess when user exist")
       void shouldDeleteUserWithSucessWhenUserExist() {
